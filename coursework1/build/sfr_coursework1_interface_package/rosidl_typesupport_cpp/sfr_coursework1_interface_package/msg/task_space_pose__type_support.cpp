...
static const _TaskSpacePose_type_support_symbol_names_t _TaskSpacePose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sfr_coursework1_interface_package, msg, TaskSpacePose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sfr_coursework1_interface_package, msg, TaskSpacePose)),
  }
};
...
{
  return &::sfr_coursework1_interface_package::msg::rosidl_typesupport_cpp::TaskSpacePose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sfr_coursework1_interface_package, msg, TaskSpacePose)() {
  return get_message_type_support_handle<sfr_coursework1_interface_package::msg::TaskSpacePose>();
}
